...
export default function Oracle() {
  ...
  const [mode, setMode] = useState<Mode>("what-next");
  ...
  return (
    <div className="min-h-screen pb-24">
      <PageHeader
        ...
        subtitle="An AI fluent in your library. The more you read, the sharper it gets. Pair with Recommendations to find the best edition of any title."
      />
      ...
      <div className="px-4 sm:px-8 lg:px-14 mt-8 grid grid-cols-12 gap-8">
        <aside className="col-span-12 lg:col-span-3 space-y-2">
          ...
          {MODES.map(m => (
            ...
            >
              <p className="font-display text-lg text-foreground">{m.l}</p>
        ...
        <section className="col-span-12 lg:col-span-9 space-y-6">
          ...
          {output && mode !== "what-next" && (
            <article className="ink-card rounded-sm p-8 animate-fade-in">
              <p className="eyebrow mb-4">Response</p>
              <div className="font-serif text-lg leading-relaxed whitespace-pre-wrap text-foreground">
                {output}
              </div>
            </article>
          )}
